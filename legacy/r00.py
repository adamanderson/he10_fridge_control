...
#  Get Lakeshore 218 data, copy to a working file, and remove + signs and commas from datafile
shutil.copy2('r00-480.data','r00-480-working-file.data')
for line in fileinput.FileInput("r00-480-working-file.data",inplace=1):
	line = line.replace("+"," ")
	line = line.replace(","," ")
...
data = loadtxt('r00-480-working-file.data')
...
#  Setup first plot for Pumps and Switches
plt.subplot(2,1,1)
plt.plot_date(timestamps, diode3, tz=None, xdate=True, ydate=False, fmt='b', label='4He IC pump')
plt.plot_date(timestamps, diode4, tz=None, xdate=True, ydate=False, fmt='g', label='3He IC pump')
plt.plot_date(timestamps, diode5, tz=None, xdate=True, ydate=False, fmt='r', label='3He UC pump') 
plt.plot_date(timestamps, diode6, tz=None, xdate=True, ydate=False, fmt='c', label='4He IC switch')
plt.plot_date(timestamps, diode7, tz=None, xdate=True, ydate=False, fmt='m', label='3He IC switch')
plt.plot_date(timestamps, diode8, tz=None, xdate=True, ydate=False, fmt='y', label='3He UC switch')
